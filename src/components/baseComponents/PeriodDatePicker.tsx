...
import {
  IDatePickerProps, DatePicker, Stack, IDatePicker, IRefObject, IStackProps, IStackTokens, IStackStyles,
} from '@fluentui/react';
...
export function PeriodDatePicker({
  ...
  const [
    datesValue,
    setDatesValue,
  ] = useState<[Date | null | undefined, Date | null | undefined]>(defaultValue ?? [undefined, undefined]);

  useEffect(() => {
    onSelectDate?.(datesValue);
  }, [datesValue]);
